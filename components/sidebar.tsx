          ...
          <ul className="space-y-2">
            <li>
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Recognized</span>
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Export notes</span>
            ...
            <li>
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Buy credits</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ml-3 flex-1 whitespace-nowrap">Reward program</span>
              </a>
            </li>
          </ul>
        </div>
