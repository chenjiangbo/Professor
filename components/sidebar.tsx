            ...
            <li>
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M2 11a1 1 0 011-1h3a1 1 0 011 1v5H3a1 1 0 01-1-1v-4zM8 6a1 1 0 011-1h3a1 1 0 011 1v10H9a1 1 0 01-1-1V6zM14 3a1 1 0 011-1h2a1 1 0 011 1v13a1 1 0 01-1 1h-3V3z"></path>
                </svg>
                <span className="ml-3 flex-1 whitespace-nowrap">Cost dashboard</span>
              </a>
            </li>
          </ul>
        </div>
