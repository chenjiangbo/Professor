...
- 视频总结工具已经很多：
  - **BibiGPT**：支持 B 站 / YouTube / 播客 / 会议 / 本地文件等，主打一键总结 + 对话，并自称「AI 课代表」，也支持 iOS 快捷指令、浏览器插件、PWA 等多端。([GitHub](https://github.com/ferstpetr777/BibiGPT?utm_source=chatgpt.com))
...
- 特点：
  - 支持 B 站、YouTube、抖音、小红书、播客、会议、本地文件等音视频 → 一键总结 + 对话；([GitHub](https://github.com/ferstpetr777/BibiGPT?utm_source=chatgpt.com))
...
**“我们做的是：NotebookLM + BibiGPT + Otter 的交集，且针对个人学习 & 双语场景做极致优化。”**
