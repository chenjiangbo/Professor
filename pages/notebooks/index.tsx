                ...
                {filteredNotebooks.map((notebook, idx) => (
                  ...
                  >
                    <button
                      ...
                      className="absolute right-10 top-2 z-10 inline-flex h-7 w-7 items-center justify-center rounded-full border border-sky-200 bg-sky-600 text-white opacity-0 shadow-sm transition hover:bg-sky-700 group-hover:opacity-100 dark:border-sky-400/40 dark:bg-sky-500 dark:hover:bg-sky-400"
                      title="Edit notebook"
                    ...
                    <button
                      ...
                      className="absolute right-2 top-2 z-10 inline-flex h-7 w-7 items-center justify-center rounded-full border border-rose-200 bg-rose-600 text-white opacity-0 shadow-sm transition hover:bg-rose-700 group-hover:opacity-100 dark:border-rose-400/40 dark:bg-rose-500 dark:hover:bg-rose-400"
